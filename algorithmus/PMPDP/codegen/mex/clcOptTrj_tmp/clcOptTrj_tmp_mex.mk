...
MAKEFILE = clcOptTrj_tmp_mex.mk

include clcOptTrj_tmp_mex.mki


SRC_FILES =  \
	clcOptTrj_tmp_data.c \
...
MEX_FILE_NAME_WO_EXT = clcOptTrj_tmp_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\clcOptTrj_tmp"
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\clcOptTrj_tmp\interface"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\clcOptTrj_tmp/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
