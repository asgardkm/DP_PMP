 ...
 *
 * Code generation for function 'clcDP_olyHyb_tmp_emxutil'
 *
 */
...
{
  emxInit_real_T(sp, &pStruct->geaRat, 2, srcLocation, doPush);
}
...
/* End of code generation (clcDP_olyHyb_tmp_emxutil.c) */
