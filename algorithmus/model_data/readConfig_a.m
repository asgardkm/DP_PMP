...
iceFlg          = str2double(value{~cellfun(@isempty, regexp(name, 'iceFlg'))}); 
...
clear disFlg iceFlg timeStp batEngStp batEngBegMin batEngBegMax batEngEndMin ...
        batEngEndMax batPwrAux psiBatEng psiTim staChgPenCosVal ...
        wayInxBeg wayInxEnd staBeg
