...
/******************************************************************************/
{
	...
	//}
	printf("      using targetFile value '%s'\n\n", targetFile);
	//bool_val = 0; // reset bool
