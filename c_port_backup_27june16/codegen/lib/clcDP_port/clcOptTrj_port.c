 ...
 * Return Type  : void
 */
void clcOptTrj_port(double wayStp, double wayNum, double wayInxBeg, double
                    ...
                    *psiEngKinOptVec, double *fulEngOpt)
{
  int ix;
  int iy;
...
/*
 * File trailer for clcOptTrj_port.c
 *
 * [EOF]
 */
