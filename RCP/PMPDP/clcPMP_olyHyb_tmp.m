function [cosHamMin,batFrcOut,fulFrcOut] = ...
    clcPMP_olyHyb_tmp(engKinPre,engKinAct,gea,slp,iceFlg,batEng,psiBatEng,...
...
if batEngStp > 0
    [ ...
        ...
        batEngDltClc_tmp... FUNCTION CALL
        (...
...
for batEngDltInx = batEngDltMinInx:batEngDltMaxInx 
    ...
    batFrc = batFrcClc_tmp(...      FUNCTION CALL
