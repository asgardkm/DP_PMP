...
MAKEFILE = clcDP_tmp_mex.mk

include clcDP_tmp_mex.mki


SRC_FILES =  \
	clcDP_tmp_mexutil.c \
	clcDP_tmp_data.c \
	clcDP_tmp_initialize.c \
...
MEX_FILE_NAME_WO_EXT = clcDP_tmp_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\clcDP_tmp"
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\clcDP_tmp\interface"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\clcDP_tmp/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
