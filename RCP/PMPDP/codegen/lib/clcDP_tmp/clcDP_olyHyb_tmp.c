                      ...
                      emxArray_real_T *cos2goActMat)
{
  ...
  fulEngOptTn3->data[fulEngOptTn3->size[0] * ((int)staBeg - 1) +
    fulEngOptTn3->size[0] * fulEngOptTn3->size[1] * ((int)wayInxBeg - 1)] = 0.0;
  ...
  cos2goPreMat->data[cos2goPreMat->size[0] * ((int)staBeg - 1)] = 0.0;
  ...
  batEngPreMat->data[batEngPreMat->size[0] * ((int)staBeg - 1)] = batEngBeg;
  ...
  fulEngPreMat->data[fulEngPreMat->size[0] * ((int)staBeg - 1)] = 0.0;
          ...
          if ((vehAcc < vehAccMin) || (vehAcc > vehAccMax)) {
            ...
            for (staPre = 0; staPre < i1; staPre++) {
              ...
              if (rtIsInf(batEngPreMat->data[engKinPreInx + batEngPreMat->size[0]
                ...
                clcPMP_olyHyb_tmp(engKinMat_engKinInx_wayInx[engKinPreInx + 11 *
                                  ((int)b_wayInx - 2)], engKinAct, 1.0 + (double)
                                  b_loop_ub, slpVec_wayInx[(int)b_wayInx - 2],
