START_DIR = C:\Users\s0032360\DOCUME~1\4Kaleb\RCP\test

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2015a
MAKEFILE = myMult_mex.mk

include myMult_mex.mki
...
MEX_FILE_NAME_WO_EXT = myMult_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\myMult"
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\myMult\interface"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\myMult/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
