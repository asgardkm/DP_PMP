...
MAKEFILE = ButterFilt_mex.mk

include ButterFilt_mex.mki
...
MEX_FILE_NAME_WO_EXT = ButterFilt
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\ButterFilt"
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\ButterFilt\interface"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\ButterFilt/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
