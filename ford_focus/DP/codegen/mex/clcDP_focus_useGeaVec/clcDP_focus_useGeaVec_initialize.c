...
static void clcDP_focus_useGeaVec_once(void);
...
void clcDP_focus_useGeaVec_initialize(emlrtContext *aContext)
{
  ...
  if (emlrtFirstTimeR2012b(emlrtRootTLSGlobal)) {
    clcDP_focus_useGeaVec_once();
  }
}

/* End of code generation (clcDP_focus_useGeaVec_initialize.c) */
