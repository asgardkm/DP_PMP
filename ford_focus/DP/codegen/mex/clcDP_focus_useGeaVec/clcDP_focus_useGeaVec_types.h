/*
 * clcDP_focus_useGeaVec_types.h
 *
 * Code generation for function 'clcDP_focus_useGeaVec'
 *
 */

#ifndef __CLCDP_FOCUS_USEGEAVEC_TYPES_H__
#define __CLCDP_FOCUS_USEGEAVEC_TYPES_H__
...
typedef struct
{
    ...
    real_T emoPwrMgd[66];
    emxArray_real_T *emoTrq_emoSpd_emoPwr;
...
#endif
/* End of code generation (clcDP_focus_useGeaVec_types.h) */
