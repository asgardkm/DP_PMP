...
MAKEFILE = clcDP_focus_mex.mk

include clcDP_focus_mex.mki


SRC_FILES =  \
	clcDP_focus_mexutil.c \
	clcDP_focus_data.c \
...
MEX_FILE_NAME_WO_EXT = clcDP_focus_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\clcDP_focus"
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\clcDP_focus\interface"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\clcDP_focus/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\clcDP_focus/%.cpp
	$(CC) $(CPPFLAGS) "$<"
