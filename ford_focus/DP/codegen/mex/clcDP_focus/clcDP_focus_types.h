...
typedef struct
{
    ...
    real_T geaRat[6];
    emxArray_real_T *iceSpdMgd;
    emxArray_real_T *iceTrqMgd;
    emxArray_real_T *iceFulPwr_iceSpd_iceTrq;
    ...
    real_T geaEfy[6];
    emxArray_real_T *iceTrqMax_emoSpd;
    emxArray_real_T *iceTrqMin_emoSpd;
} struct2_T;
