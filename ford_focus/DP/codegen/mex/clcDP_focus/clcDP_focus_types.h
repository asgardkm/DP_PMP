...
typedef struct
{
    ...
    real_T geaEfy[6];
    real_T icePwr_emoSpd_emoTrq[570];
    real_T iceTrqMax_emoSpd[48];
    real_T iceTrqMin_emoSpd[48];
} struct2_T;
#endif /*typedef_struct2_T*/
#ifndef typedef_clcDP_focusStackData
#define typedef_clcDP_focusStackData
typedef struct
{
    struct
    {
...
} clcDP_focusStackData;
#endif /*typedef_clcDP_focusStackData*/
