...
static emlrtRSInfo q_emlrtRSI = { 181, "optTrqSplit_focus",
  "C:\\Users\\s0032360\\Documents\\GitHub\\DP_PMP\\ford_focus\\DP\\optTrqSplit_focus.m"
};

static emlrtRSInfo r_emlrtRSI = { 182, "optTrqSplit_focus",
  "C:\\Users\\s0032360\\Documents\\GitHub\\DP_PMP\\ford_focus\\DP\\optTrqSplit_focus.m"
};

static emlrtRSInfo s_emlrtRSI = { 183, "optTrqSplit_focus",
  "C:\\Users\\s0032360\\Documents\\GitHub\\DP_PMP\\ford_focus\\DP\\optTrqSplit_focus.m"
};

static emlrtRSInfo t_emlrtRSI = { 193, "optTrqSplit_focus",
  "C:\\Users\\s0032360\\Documents\\GitHub\\DP_PMP\\ford_focus\\DP\\optTrqSplit_focus.m"
};

static emlrtRSInfo w_emlrtRSI = { 60, "fulEngClc_focus",
...
static emlrtBCInfo uc_emlrtBCI = { 1, 100, 41, 15, "Z", "codegen_interp2",
  "C:\\Users\\s0032360\\Documents\\GitHub\\DP_PMP\\ford_focus\\DP\\codegen_interp2.m",
  0 };
...
static emlrtBCInfo vc_emlrtBCI = { 1, 150, 35, 10, "Z", "codegen_interp2",
  "C:\\Users\\s0032360\\Documents\\GitHub\\DP_PMP\\ford_focus\\DP\\codegen_interp2.m",
  0 };
...
static emlrtBCInfo wc_emlrtBCI = { 1, 100, 26, 21, "Z", "codegen_interp2",
  "C:\\Users\\s0032360\\Documents\\GitHub\\DP_PMP\\ford_focus\\DP\\codegen_interp2.m",
  0 };
...
static emlrtBCInfo xc_emlrtBCI = { 1, 150, 25, 10, "Z", "codegen_interp2",
  "C:\\Users\\s0032360\\Documents\\GitHub\\DP_PMP\\ford_focus\\DP\\codegen_interp2.m",
  0 };
...
static emlrtBCInfo yc_emlrtBCI = { 1, 100, 24, 23, "Z", "codegen_interp2",
  "C:\\Users\\s0032360\\Documents\\GitHub\\DP_PMP\\ford_focus\\DP\\codegen_interp2.m",
  0 };
...
static emlrtBCInfo ad_emlrtBCI = { 1, 150, 24, 10, "Z", "codegen_interp2",
  "C:\\Users\\s0032360\\Documents\\GitHub\\DP_PMP\\ford_focus\\DP\\codegen_interp2.m",
  0 };
...
real_T optTrqSplit_focus(const emlrtStack *sp, real_T brkBool, real_T batPwr,
  ...
  real_T iceTrqMaxPos, real_T iceTrqMinPos, real_T timeStp, const real_T
  ...
  if ((crsSpdPre > crsSpdHybMax) || (crsSpdPre < crsSpdHybMin)) {
    ...
    if ((emoPwrMinPos > batCur) || (emoPwrMaxPos < batCur)) {
      ...
      if ((emoTrqMinPos > batCur) || (emoTrqMaxPos < batCur) || (crsTrqPre >
        ...
        if ((iceTrq > iceTrqMaxPos) || (iceTrq < iceTrqMinPos) || (!(brkBool !=
              0.0))) {
        } else {
          ...
          if (vehVelVec[0] < muDoubleScalarAbs(fzg_scalar_struct_vehVelThresh))
          {
            ...
            idxi = (iceTrq - fzg_array_struct->iceTrqMgd[0]) * (1.0 /
              ...
              + 1.0;
            if ((idxi <= 1.0) || (idyi <= 1.0) || (idxi > 38.0) || (idyi > 24.0)
                || muDoubleScalarIsNaN(crsSpdPre) || muDoubleScalarIsNaN(iceTrq))
            {
              batCur = rtInf;
              ...
              i9 = (int32_T)emlrtIntegerCheckFastR2012b(batCur, &wb_emlrtDCI,
                &b_st);
              emlrtDynamicBoundsCheckFastR2012b(i9, 1, 150, &ad_emlrtBCI, &b_st);
              batCur = muDoubleScalarCeil(idyi) - 1.0;
              i9 = (int32_T)emlrtIntegerCheckFastR2012b(batCur, &vb_emlrtDCI,
                &b_st);
              emlrtDynamicBoundsCheckFastR2012b(i9, 1, 100, &yc_emlrtBCI, &b_st);
              batCur = muDoubleScalarCeil(idxi) - 1.0;
              i9 = (int32_T)emlrtIntegerCheckFastR2012b(batCur, &ub_emlrtDCI,
                &b_st);
              emlrtDynamicBoundsCheckFastR2012b(i9, 1, 150, &xc_emlrtBCI, &b_st);
              ...
              i9 = (int32_T)emlrtIntegerCheckFastR2012b(batCur, &rb_emlrtDCI,
                &b_st);
              emlrtDynamicBoundsCheckFastR2012b(i9, 1, 100, &wc_emlrtBCI, &b_st);
              batCur = muDoubleScalarCeil(idxi);
              ...
              batCur = ((fzg_array_struct->iceFulPwr_iceSpd_iceTrq[((int32_T)
                ...
                (muDoubleScalarCeil(idyi) - 1.0) - 1)) - 1] *
                         (muDoubleScalarCeil(idxi) - idxi) * (muDoubleScalarCeil
                          (idyi) - idyi) +
              ...
              i9 = (int32_T)emlrtIntegerCheckFastR2012b(batCur, &ob_emlrtDCI,
                &b_st);
              emlrtDynamicBoundsCheckFastR2012b(i9, 1, 150, &vc_emlrtBCI, &b_st);
              ...
              i9 = (int32_T)emlrtIntegerCheckFastR2012b(batCur, &kb_emlrtDCI,
                &b_st);
              emlrtDynamicBoundsCheckFastR2012b(i9, 1, 100, &uc_emlrtBCI, &b_st);
              batCur = muDoubleScalarCeil(idyi);
              emlrtIntegerCheckFastR2012b(batCur, &jb_emlrtDCI, &b_st);
              batCur = fzg_array_struct->iceFulPwr_iceSpd_iceTrq[((int32_T)idxi
                + 150 * ((int32_T)(muDoubleScalarCeil(idyi) - 1.0) - 1)) - 1] *
                (muDoubleScalarCeil(idyi) - idyi) +
              ...
              batCur = fzg_array_struct->iceFulPwr_iceSpd_iceTrq[((int32_T)
                ...
                ((int32_T)emlrtIntegerCheckFastR2012b(idyi, &yb_emlrtDCI, &b_st)
                 - 1)) - 1];
            }

            /*  since P = E/t, then E=P*t */
            fulEng = batCur * timeStp;
          }
