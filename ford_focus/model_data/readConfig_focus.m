...
timeInxBeg       = str2double(value{~cellfun(@isempty, regexp(name, 'timeInxBeg'))});
timeInxEnd       = str2double(value{~cellfun(@isempty, regexp(name, 'timeInxEnd'))});
...
fileparams = struct('disFlg',           disFlg,         ...
                    ...
                    'timeInxBeg',       timeInxBeg,     ...
                    'timeInxEnd',       timeInxEnd,     ...
                    'engBeg',           engBeg,         ...
                    'engEnd',           engEnd,         ...
                    'staBeg',           staBeg          ...
                );
...
clear disFlg iceFlgBool timeStp batEngStp batEngBegMinRat batEngBegMaxRat batEngEndMinRat ...
        batEngEndMaxRat batPwrAux staChgPenCosVal timeInxBeg timeInxEnd ...
